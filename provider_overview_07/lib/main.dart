...
import 'package:provider_overview_07/model/dog.dart';
    ...
    return MultiProvider(
      providers: [
        ...
        StreamProvider<String>(
            create: (context) {
              // 아래의 read를 watch로 변경하면 오류발생함.
              // create 는 기본적으로 어플리케이션이 로드될때 1회만 호출된다.
              // create에 watch를 쓰는것은 맞지않다는 오류이다.
              final int dogAge = context.read<Dog>().age;
              final babies = Babies(age: dogAge * 2);
              return babies.bark();
            },
            initialData: 'not yet to bark')
      ],
      child: MaterialApp(
        title: 'Template',
        theme: ThemeData(
